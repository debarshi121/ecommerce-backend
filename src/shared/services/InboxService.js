// src/shared/services/InboxService.js
...
class InboxService {
  constructor({ inboxRepository, transactionManager }) {
  ...
  async isProcessed(eventId, queue) {
  ...
  async startProcessing({ eventId, eventName, module, queue, payload }, tx) {
  ...
  async complete(inboxRecordId, tx) {
  ...
  async fail({ eventId, eventName, module, queue, payload }, error) {
    try {
  ...
  async processEvent({ event, module, queue, handler }) {
